...
class i_rodCenter_VC: UIViewController {
    ...
    func addSolveButton() {
        ...
        btn.addTarget(self, action: #selector(i_rodCenter_VC.btnAction(_ :)), for: .touchUpInside)
    }
    ...
    func addClearAllButton() {
        ...
        btn2.addTarget(self, action: #selector(i_rodCenter_VC.btnClearAction(_ :)), for: .touchUpInside)
    }
    ...
    @objc func btnAction(_ sender: UIButton!) {
        ...
        answerBox.text = "I(rod center) = \(answer)"
        
        setUpBox.text = "I = Mass * Length^2 / 12\nI = \(a) * \(b)^2 / 12\nI = \(answer)"
    }
    ...
    private func configureTapGesture() {
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(i_rodCenter_VC.handleTap))
...
extension i_rodCenter_VC: UITextFieldDelegate {
